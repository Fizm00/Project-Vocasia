    ...
    <header className="bg-darkGreen shadow-md p-4 sticky top-0 z-50">
      <div className="container ml-1 mr-0 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2">
          <img src="./src/assets/logo-anakkost.png" alt="Logo" className="w-8 h-8" />
        ...
        <div className="flex items-center mr-2 space-x-8 hidden md:flex">
          ...
          {isLoggedIn ? (
            ...
            <Link to="/login" className="bg-white text-darkGreen text-sm font-semibold p-2 px-6 rounded-full hover:bg-hoverGreen hover:text-white transition duration-200">
              Masuk
            </Link>
          )}
        </div>
      ...
      {isMenuOpen && (
        <div className="flex flex-col items-center mt-4 bg-darkGreen p-4 md:hidden">
          <Link to="/" className="text-md font-semibold text-white py-2">Beranda</Link>
          <Link to="/search" className="text-md font-semibold text-white py-2">Search</Link>
          <Link to="/about" className="text-md font-semibold text-white py-2">About</Link>
          <Link to="/contact" className="text-md font-semibold text-white py-2">Contact</Link>
