...
const RincianPembayaran = ({ totalBiaya }) => {
  ...
  return (
    <aside
      className="bg-white border border-gray-200 rounded-xl shadow-lg p-4 w-full max-w-full lg:max-w-sm lg:ml-auto space-y-4 transition-transform transform hover:scale-105"
      style={{
        minHeight: "300px",
        height: "fit-content",
        marginBottom: "2rem",
